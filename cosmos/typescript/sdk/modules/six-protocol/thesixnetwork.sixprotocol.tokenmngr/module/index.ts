...
import { MsgSendAsix } from "./types/tokenmngr/tx";
...
import { MsgConvertToMicro } from "./types/tokenmngr/tx";
...
import { MsgConvertToAtto } from "./types/tokenmngr/tx";
...
const types = [
  ...
  ["/thesixnetwork.sixprotocol.tokenmngr.MsgSendAsix", MsgSendAsix],
  ...
  ["/thesixnetwork.sixprotocol.tokenmngr.MsgConvertToMicro", MsgConvertToMicro],
  ...
  ["/thesixnetwork.sixprotocol.tokenmngr.MsgConvertToAtto", MsgConvertToAtto],
...
const txClient = async (wallet: OfflineSigner, { addr: addr }: TxClientOptions = { addr: "http://localhost:26657" }, options?: SigningStargateClientOptions) => {
  ...
  return {
    ...
    msgSendAsix: (data: MsgSendAsix): EncodeObject => ({ typeUrl: "/thesixnetwork.sixprotocol.tokenmngr.MsgSendAsix", value: MsgSendAsix.fromPartial( data ) }),
    ...
    msgConvertToMicro: (data: MsgConvertToMicro): EncodeObject => ({ typeUrl: "/thesixnetwork.sixprotocol.tokenmngr.MsgConvertToMicro", value: MsgConvertToMicro.fromPartial( data ) }),
    ...
    msgConvertToAtto: (data: MsgConvertToAtto): EncodeObject => ({ typeUrl: "/thesixnetwork.sixprotocol.tokenmngr.MsgConvertToAtto", value: MsgConvertToAtto.fromPartial( data ) }),
